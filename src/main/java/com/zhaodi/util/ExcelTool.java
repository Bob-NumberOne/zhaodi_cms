...
public class ExcelTool {
    ...
    public static JSONArray readExcel(File file,Map<String,String> m,List<String> col_list) {
        ...
        try {
            ...
            if(m.get("isImage").equals("1")){//当需要加载excel中图片时
                ...
                Map<Integer, PictureData> imgData=getImage(book,m.get("uploadRoot"),m.get("uploadSubDir"));
                array.add(imgData);
            }
        } catch (Exception e) {
            e.printStackTrace();
     ...
     */
    public static Map<Integer, PictureData> getImage(Workbook book, String uploadRoot, String uploadSubDir) throws IOException {
            ...
            for (POIXMLDocumentPart dr : ((XSSFSheet) sheet).getRelations()) {
                if (dr instanceof XSSFDrawing) {
                    ...
                    for (XSSFShape shape : shapes) {
                        ...
                        sheetIndexPicMap.put(ctMarker.getRow(),picData);
                    }
                }
            }
